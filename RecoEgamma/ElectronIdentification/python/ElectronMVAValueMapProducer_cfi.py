...
from RecoEgamma.ElectronIdentification.Identification.mvaElectronID_Fall17_iso_V2_HZZ_cff \
    import mvaEleID_Fall17_iso_V2_HZZ_producer_config
mvaConfigsForEleProducer.append( mvaEleID_Fall17_iso_V2_HZZ_producer_config )

from RecoEgamma.ElectronIdentification.Identification.mvaElectronID_Fall17_noIso_V2_TMVA_cff \
    import mvaEleID_Fall17_noIso_V2_TMVA_producer_config
mvaConfigsForEleProducer.append( mvaEleID_Fall17_noIso_V2_TMVA_producer_config )

from RecoEgamma.ElectronIdentification.Identification.mvaElectronID_Fall17_iso_V2_TMVA_cff \
