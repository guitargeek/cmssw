...
slimmedElectronsWithUserData = cms.EDProducer("PATElectronUserDataEmbedder",
    ...
    userFloats = cms.PSet(
        ...
        PFIsoLep = cms.InputTag("isoForEle:PFIsoLep"),
...
electronTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(CandVars,
        ...
        pfRelIso03_all = Var("userFloat('PFIsoAll')/pt",float,doc="PF relative isolation dR=0.3, total with rho*EA PU corrections: chg + max(0, neu + pho - rho*EA))"),
        pfRelIso03_lep = Var("userFloat('PFIsoLep')/pt",float,doc="PF relative isolation dR=0.3, leptonic component with veto at dR < 0.0005 to avoid self contribution"),
